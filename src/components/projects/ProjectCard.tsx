        ...
        {displayedProjects.map((items, index) => {
          ...
          return (
            <React.Fragment key={items.id}>
              ...
              {showDesktopSep && (
                <div className="col-span-2 devygram-line-top devygram-line-bottom hidden h-3 sm:block" />
              )}

              {/* Full-screen-width separator on mobile */}
              {showMobileSep && (
                <div className="devygram-line-top devygram-line-bottom block h-3 sm:hidden" />
              )}
            </React.Fragment>
          );
        })}
