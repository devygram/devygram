...
export default function LoaderDocPage() {
  ...
  const cliCommands: Record<PackageManager, string> = {
    pnpm: 'pnpm dlx shadcn@latest add https://devygram.com/r/loader-animation.json',
    npm: 'npx shadcn@latest add https://devygram.com/r/loader-animation.json',
    yarn: 'npx shadcn@latest add https://devygram.com/r/loader-animation.json',
    bun: 'bunx --bun shadcn@latest add https://devygram.com/r/loader-animation.json',
  };
    ...
    <div className="w-full border-none">
      ...
      <div data-doc-cols-ready="">
        ...
        <div data-slot="doc-container" className="mx-auto w-full">
          <div className="devygram-line-bottom h-px" />
          ...
          <div className="devygram-line-top devygram-line-bottom py-px">
            <div className="mx-auto h-4 w-full" />
          </div>

          {/* Title Header */}
          <div className="devygram-line-bottom">
            <h1
              data-slot="doc-title"
