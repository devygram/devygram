      ...
      <div>
        <div>
          <SectionHeading
            ...
            heading="Blogs"
          />
          <h1 className="devygram-line-bottom px-4 text-3xl font-semibold tracking-tight text-balance">
            Showcase of Blogs
          </h1>
        </div>
        <div className="devygram-line-top devygram-line-bottom flex items-center justify-between p-2">
          <Link
            data-slot="button"
            data-variant="link"
            data-size="sm"
