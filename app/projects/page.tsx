...
export const metadata: Metadata = {
  ...
  description:
    'Explore web applications, React & Next.js projects, open source tools, and interactive designs built by Devender Papani (DevyGram).',
  alternates: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Devender Papani (DevyGram) | Web Development Projects',
      },
    ],
  },
  twitter: {
